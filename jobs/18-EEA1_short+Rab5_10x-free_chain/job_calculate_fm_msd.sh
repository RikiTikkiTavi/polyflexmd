...
#SBATCH --job-name="polyflexmd-18-calculate_fm_msd-ef6e4e76"
...
EXPERIMENT_PATH = "/beegfs/ws/0/s4610340-polyflexmd/data/experiment_results/FENE-beadspring-free_chain-vary-l_K-vary-d_end/18-EEA1_short+Rab5_10x-free_chain/ef6e4e76"
