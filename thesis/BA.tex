...
Likely the topic has already been studied in several works and
a summary which covers some of the relevant observables for this work 
is available in the appendix of 
Nikoubashman \textit{et al.} \cite{Nikoubashman2016}.
\\
\\
Chain stiffness affects the dynamics on short time scales and 
does not affect the chain translational diffusion as a whole
\cite{Nikoubashman2016}. To provide the overview over the 
relevant quantities the one needs to destinguish between 
coil limit ($l_p \ll L$) and rod limit ($l_p \gg L$).
In coil limit 
...
\begin{figure}
    ...
    Grey dashed lines correspond to $3/4$ and $2/3$ values.
    }
    \label{fig:alpha_anchored_zeta}
\end{figure}
...
\begin{table}
    ...
    \midrule
    1 & 6.02 & 78162.53 & 11.00 & 0.94 & 0.736 & 0.004 \\
    10 & 6.02 & 781625.32 & 1.65 & 9.41 & 0.739 & 0.004 \\
    1 & 0.6 & 6352.27 & 11.00 & 0.94 & 0.653 & 0.004 \\
    \bottomrule
    \end{tabular}
    \caption{
