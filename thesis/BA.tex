...
\\
Secondly, a drop of $\alpha_{min}$ is observed 
(from $0.73\pm0.02$ to $0.652\pm0.002$, $\Delta\approx0.08$) during the
transition from $l_K/L=6.02$ to the $l_K/L=0.6$ by $\zeta_e=\zeta=1$ 
(\autoref{fig:alpha_fm_free}). Both values are very close 
...
In case $l_K/L=6.02$ from $0.73 \pm 0.02$ to $0.67 \pm 0.02$, $\Delta=0.06\pm0.03$.
In case $l_K/L=0.6$ from $0.652 \pm 0.002$ to $0.640 \pm 0.002$, $\Delta=0.012\pm0.003$.
...
decreasing stiffness of the chain.
\\
\\
Furthermore, analyzing transition from $l_K/L=6.02$, $\zeta_e=1$ 
to the $l_K/L=6.02$, $\zeta_e=10$, which models the transition from 
EEA1 to the EEA1+RAB5, one can see the decrease of the $\alpha_{min}$ from
the $0.73 \pm 0.02$ to the $0.64 \pm 0.002$, $\Delta=0.09 \pm 0.02$.
This result is qualitatively and quantitatively comptatible with the change
