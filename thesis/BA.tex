...
representation the one can find in Figure \ref{fig:msd_anchored_l_K_log}.
...
accounts location of the transition into the plateau. However, the one
...
the scaling behavior of empirical MSD is analyzed. Assuming that
$\E{[\Delta \vec{R}(t)]^2} \propto t^{\alpha(t)}$ is also valid for
anchored chain, the scaling exponent $\alpha$ is estimated from MSD curves as 
