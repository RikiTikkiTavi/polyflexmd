...
\ref{fig:msd_anchored_l_K_rouse_fit_tau-a}. and
\ref{fig:msd_anchored_l_K_rouse_fit_tau-a_log}.
...
\begin{figure}[h]
    \begin{center}
      \includegraphics[width=\columnwidth,trim={0cm 0cm 0cm 0.0cm},clip]{4-exp-delta_R-rouse_fit-tau-a.png}
      \caption{\label{fig:msd_anchored_l_K_rouse_fit_tau-a}
      Empirical MSD of ETE of anchored chains with different Kuhn length values (blue line)
      and fit of modified Rouse model prediction for semi-flexible chains 
      (Eq.\ref{eq:adjusted_rouse_model_ete}, dashed line).
      }
    \end{center}
\end{figure}
\begin{figure}[h]
    \begin{center}
      \includegraphics[width=\columnwidth,trim={0cm 0cm 0cm 0.0cm},clip]{4-exp-delta_R-rouse_fit-tau-a_log.png}
      \caption{\label{fig:msd_anchored_l_K_rouse_fit_tau-a_log}
      Empirical MSD of ETE of anchored chains with different Kuhn length values (blue line)
      and fit of modified Rouse model prediction for semi-flexible chains 
...
is varied: $\zeta_e = 10.0,15.0$, which corresponds to the end-bead diamaters: $15.0, 30.0.$
