...
In this subsection, a comparative analysis between the 
dynamics of anchored polymer chains and their free counterparts is conducted.
...
\begin{figure}[h]
    \begin{center}
      ...
      Filled area corresponds to the confidence interval.
      }
    \end{center}
\end{figure}
...
$\tau_R=582.3 \pm 28.6$, $\tau_0=4.21 \pm 0.07$, which is approximately 4 times
larger. The fitted curve is displayed on Fig.
\ref{fig:anchored_flex_chain_vs_rouse_fitted}. 

\begin{figure}[h]
    \begin{center}
      \includegraphics[width=\columnwidth,trim={0cm 0cm 0cm 0.9cm},clip]{3-exp-free-param-log.png}
