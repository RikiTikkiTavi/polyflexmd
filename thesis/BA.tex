...
In conclusion, the goals of this work are partially achieved.
\paragraph{Anchored chains}
The specific dynamical quantity MSD of ETE (in following: MSD) was considered. It is shown,
...
$\tau_R$ as free parameter, effectively deliver the correction factor for $\tau_R$
to account for anchoring.
\\
\\
