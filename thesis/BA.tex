...
is available in the literature \cite{Nikoubashman2016}.
\\
\\
...
\begin{equation}
    \E{[\Delta \vec{r}_N(t)]^2} \approx l_b^2(\frac{b}{l_p})^{1/4}(\frac{t}{\tau_0})^{3/4} \text{, if } \tau_0 < t < \tau_1 \text{; } l_p \gg L
\end{equation}
...
analyzed and results are shown on Figure \ref{fig:msd_anchored_zeta-dim}.
...
of the two hypothesis arising from the discussion in the paper of 
\emph{Singh et. al.} \cite{Singh:2022}. Their work shows, that upon the 
...
the scaling regime of MSDLM $\alpha=3/4$ corresponds the chains in the rod limit and
the $\alpha=2/3$ to the fully flexible chains in presence of excluded
volume interactions. However, it is unclear if the change of scaling behavior
is caused by the stiffness transformation or by the change of friction
coefficient of the chains end. Using the molecular dynamics it's possible
to isolate the the both cases and consider them separately. 
...
\begin{table}
    ...
    \begin{tabular}{rrlllrrr}
        ...
        \midrule
        1 & 6.02 & 78162.53 & 11.00 & 0.94 & 0.727000 & 0.001000 & 0.750000 \\
        10 & 6.02 & 781625.32 & 1.65 & 9.41 & 0.803000 & 0.001000 & 0.750000 \\
        1 & 0.6 & 6352.27 & 11.00 & 0.94 & 0.659000 & 0.002000 & 0.666667 \\
        1 & $\approx 0.01$ & 0.12 & 11.00 & 0.94 & 0.500000 & 0.015000 & 0.666667 \\
        \bottomrule
        \end{tabular}
    \caption{
